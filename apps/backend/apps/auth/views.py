...
def profile_view(request):
    """Returns the authenticated user's full profile including resolved role tier."""
...
def moderator_only_view(request):
    """
    Example protected view for Moderator / Contributor tier.
    Only users with role 'moderator' or 'superadmin' can access.
    """
...
def superadmin_only_view(request):
    """
    Example protected view for Superadmin / Admin tier.
